        ...
        <View className="flex-1">
          ...
          {isPro ? (
            <View className="flex-1 items-center justify-center px-6 pb-20">
              <Animated.View entering={FadeInUp.delay(200)} className="w-32 h-32 rounded-full bg-[#FF4D00]/20 items-center justify-center border-4 border-[#FF4D00]/30 mb-8">
                <Ionicons name="sparkles" size={60} color="#FF4D00" />
              </Animated.View>
              <Animated.View entering={FadeInUp.delay(300)} className="items-center">
                <Text className="text-white text-5xl font-black italic tracking-tighter text-center leading-[50px]">
                  You're a <Text className="text-[#FF4D00]">Pro</Text>
                </Text>
                <Text className="text-gray-400 font-bold text-center mt-6 leading-6 px-4">
                  Thank you for being part of Nexus Pro. You have full priority access to unlimited course publishing, lower platform fees, and advanced creator analytics.
                </Text>
              </Animated.View>
              <Animated.View entering={FadeInUp.delay(400)}>
                <TouchableOpacity
                  onPress={() => router.back()}
                  className="bg-white/10 border border-white/20 px-8 py-4 rounded-full mt-12"
                >
